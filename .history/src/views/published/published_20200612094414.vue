        ...
        <div class="fl">
          <div>
            ...
            >
              ...
              <el-table-column property="abstract" label="类目" width="120"></el-table-column>
              <el-table-column property="source" label="来源" width="120"></el-table-column>
              <el-table-column property="star" label="重要性" width="120"></el-table-column>
              <el-table-column property="date" label="发布时间" width="120"></el-table-column>
