        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <!-- <el-form-item label="邮箱" prop="email">
            ...
            <el-form-item >
              ...
              <el-button type="primary" @click="rigister()" class="register-box">注册</el-button>
            </el-form-item>
...
<script>
 export default {
   ...
   methods: {
      rigister() {   //$refs 获取到dom元素  上面ref绑定了ruleForm  也可以通过传一个实参 这里传形参
