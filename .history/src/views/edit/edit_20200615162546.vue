<template>
  ...
  <div class="my-box">
    ...
    <div class="my-box1">
      <!-- 第三个盒子设置头部颜色 -->
      <div class="my-box2 fl j-around">
          <!-- 设置样式 -->
          <el-button class="style1" size="small" @click="goback">返回</el-button>
...
export default {
    ...
    submitForm() {
      axios.post('/api/article/create',{
        ...
        this.$router.push('/published')
          ...
          this.$message.error('修改文章失败,所有内容不能为空,请重新编辑')
        }
  ...
  mounted() {
  this.ruleForm =  this.$route.query.edit
  console.log(this.edit);
  // 页面一加载在就把 拿到的数据赋值给 展示数组  
  // this.ruleForm  = this.edit 
  },
  watch: {},
  computed: {}
};
