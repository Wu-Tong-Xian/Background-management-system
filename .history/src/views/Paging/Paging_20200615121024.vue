...
<!-- Form -->
<el-button type="text" @click="dialogFormVisible = true"><el-button class="el-button" size="mini" type="danger" @click="handlEamend(scope.$index, scope.row)">修改</el-button></el-button>
