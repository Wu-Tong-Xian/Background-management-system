        ...
        <el-table-column width="250" label="操作">
          <template slot-scope="scope">
            <div class="j-around fl">
              <!-- Form -->
              <div @click="handleChange(scope.$index, scope.row)">
                <el-button type="danger" @click="dialogFormVisible = true">修改</el-button>
              </div>
              <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
                <el-form :model="form">
                  <el-form-item label="商品" :label-width="NAME">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="原价" :label-width="ORI_PRICE">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                  </el-form-item>
                  <el-form-item label="现价" :label-width="PRESENT_PRICE">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                  </el-form-item>
                </el-form>
