...
<!-- Form -->
<el-button type="text" @click="dialogFormVisible = true"><el-button class="el-button" size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">修改</el-button></el-button>
...
<el-dialog title="收货地址" :visible.sync="dialogFormVisible">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="dialogFormVisible = false">确 定</el-button>
                ...
                <el-button class="el-button" size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, rows) {   //这里的rows就代表当前点击项的所有内容 是一个对象所以不能用数组和字符串的方法
