      ...
      <div class="fl">
        <div >
          ...
          class="m0 t-center j-center"
            ...
            style="width: 100%"
          >
            <div> <el-table-column label="#" type="index" width="50"></el-table-column></div>
           <div> <el-table-column property="title" label="名称" width="400"></el-table-column></div>
           <div> <el-table-column property="author" label="商品编号" width="200"></el-table-column></div>
           <div> <el-table-column property="category" label="原价" width="200"></el-table-column></div>
           <div> <el-table-column property="source" label="现价" width="200"></el-table-column></div>
           <div> <el-table-column width="200" label="操作" class=" m0 j-center t-center">
