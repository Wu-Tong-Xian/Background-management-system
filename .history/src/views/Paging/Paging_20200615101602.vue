      ...
      <div class="fl">
        <div>
          ...
          >
            ...
            <el-table-column property="author" label="商品编号" width="250"></el-table-column>
            <el-table-column property="category" label="原价" width="200"></el-table-column>
            <el-table-column property="source" label="现价" width="200" class="t-center m0 mg-l20"></el-table-column>
            <el-table-column width="300" label="操作" class="t-center">
