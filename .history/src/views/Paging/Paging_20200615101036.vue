      ...
      <div class="fl">
        <div>
          ...
          >
            ...
            <el-table-column property="title" label="名称" width="300"></el-table-column>
            <el-table-column property="author" label="商品编号" width="150"></el-table-column>
            <el-table-column property="category" label="原价" width="100"></el-table-column>
            <el-table-column property="source" label="现价" width="100"></el-table-column>
