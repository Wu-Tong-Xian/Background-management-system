<template>
  ...
  <div class="layout">
    ...
    <div class="block">
      ...
      <download-excel
        class="export-excel-wrapper mg20"
        :data="Article.slice((currentPage-1)*sizeChange,currentPage*sizeChange)"
        :fields="json_fields"
        name="filename.xls"
      >
        <!-- 上面可以自定义自己的样式，还可以引用其他组件button -->
        <el-button type="primary"  size="small">Excel导出当前页</el-button> 
      </download-excel>
  ...
  data() {
    return {
      json_fields: {
        ...
        "原价": "ORI_PRICE", //支持嵌套属性
        "现价": "PRESENT_PRICE", //支持嵌套属性
        
      },
      
      
      obj: {}, //用来接收 点击编辑之后点击的这一项的对象

      dialogFormVisible: false, //点击编辑的弹出 默认是false 点击后修改为true
      form: {
        name: "",
        region: "",
        date1: "",
