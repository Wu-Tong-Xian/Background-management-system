<template>
  ...
  <div class="layout">
    ...
    <div class="fl">
        <el-button type="danger" @click="handleDelete(scope.$index,scope.row)">导出</el-button>
        <el-button type="danger" @click="handleDelete(scope.$index,scope.row)">导出csv</el-button>
    </div>
  </div>
</template>
