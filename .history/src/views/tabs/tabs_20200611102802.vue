    ...
    <div class="mark">
      <el-tabs type="border-card">
        <el-tab-pane label="未读信息">
          ...
          <div>
            <el-button size="small" type="primary" class="el-all" @click="flag1(item)">全部标为已读</el-button>
          </div>
        </el-tab-pane>
        ...
        <el-tab-pane label="已读信息">
          ...
          <div>
            <el-button size="small" type="danger" class="el-all" @click="del1(item)">删除全部</el-button>
          </div>
        </el-tab-pane>
