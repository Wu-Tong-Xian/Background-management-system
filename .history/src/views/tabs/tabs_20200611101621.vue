    ...
    <div class="mark">
      <el-tabs type="border-card">
        <el-tab-pane label="未读信息">
            ...
            <div v-if="item.flag ===1">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" class="el-btn" @click="yd">标为已读</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="primary" class="el-all">全部标为已读</el-button>
          </div>
        </el-tab-pane>
        ...
        <el-tab-pane label="已读信息">
            ...
            <div v-if="item.flag ===2">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" type="danger" class="el-btn" @click="alterFlag">删除</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="danger" class="el-all">删除全部</el-button>
          </div>
        </el-tab-pane>
        <el-tab-pane label="回收站">
            ...
            <div v-if="item.flag ===3">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" class="el-btn" type="warning">还原</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="info" class="el-all">清空回收站</el-button>
          </div>
        </el-tab-pane>
      </el-tabs>
    </div>
  ...
  data() {
    return {
      tabs: [
        ...
        { text: "成都", time: "2019-12-13 12:02:45", flag: 1 },
        { text: "喜欢你", time: "2019-12-13 12:02:45", flag: 1 },
        { text: "南山南", time: "2019-12-13 12:02:45", flag: 2 },
        { text: "冷雨夜", time: "2019-12-13 12:02:45", flag: 2 },
