    ...
    <div class="mark">
      <el-tabs type="border-card">
        <el-tab-pane label="未读信息">
            ...
            <div v-if="item.flag ===1">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" class="el-btn" @click="flag1(item)">标为已读</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="primary" class="el-all" @click="allFlag1(item)">全部标为已读</el-button>
          </div>
        </el-tab-pane>
        ...
        <el-tab-pane label="已读信息">
            ...
            <div v-if="item.flag ===2">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" type="danger" class="el-btn" @click="flag2(item)">删除</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="danger" class="el-all" @click="allFlag2(item)">删除全部</el-button>
          </div>
        </el-tab-pane>
        <el-tab-pane label="回收站">
            ...
            <div v-if="item.flag ===3">
              <div class="tabs-for fl j-between">
                ...
                <div class="fl">
                  <div>{{item.time}}</div>
                  <div>
                    <el-button size="small" class="el-btn" type="warning" @click="flag3(item)">还原</el-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <el-button size="small" type="info" class="el-all" @click="allFlag3(item)">清空回收站</el-button>
          </div>
        </el-tab-pane>
      </el-tabs>
    </div>
