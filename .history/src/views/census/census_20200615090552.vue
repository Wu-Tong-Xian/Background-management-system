<template>
  <div class="layout">
    ...
    <div class="census-box">
      <div class="census-pie"><ve-pie :data="chartData1" class="pie"></ve-pie></div>
      <div><ve-pie :data="chartData2" :settings="chartSettings"></ve-pie></div>
    </div>
  </div>
</template>
