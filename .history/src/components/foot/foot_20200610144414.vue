    ...
    gethomeChat(){
      axios.get('/api/homeChat').then(res =>{
        // console.log(res.data.data);
         this.chartData1.columns = Object.keys(res.data.data)
         this.chartData1.rows = res.data.data

         this.chartData4.rows = res.data.data
         this.chartData4.columns = Object.keys(res.data.data)
      }).catch(err =>{
        console.log(err);
      })
    },
    ...
    getradarChat(){
      axios.get('/api/radarChat').then(res =>{
        // console.log(res.data.data);
         ...
         this.chartData2.columns = Object.keys(res.data.data)
      }).catch(err =>{
        console.log(err);
      })
    },
    ...
    getringChat(){
      axios.get('/api/ringChat').then(res =>{
        // console.log(res.data.data);
         ...
         this.chartData3.columns = Object.keys(res.data.data)
      }).catch(err =>{
        console.log(err);
      })
    },
